...
head = Label(root, text='Email Spam Message Predictor',font=('Arial', 30 , 'bold',))
head.pack()
e = Entry(root, width=800,borderwidth=5,font=('Arial 28'))
e.pack(padx=15, pady=15)
b = Button(root, text = 'Predict', font=('Arial', 40 , 'bold'), fg = 'white', bg = 'red', command = sms)
